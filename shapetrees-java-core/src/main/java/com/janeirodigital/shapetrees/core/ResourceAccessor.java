...
public interface ResourceAccessor {
    ...
    ShapeTreeResource createResource(ShapeTreeContext context, String method, URI resourceURI, HttpClientHeaders headers, String body, String contentType) throws ShapeTreeException;
