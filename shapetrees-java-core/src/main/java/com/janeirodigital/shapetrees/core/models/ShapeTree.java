...
public class ShapeTree {
    ...
    public ValidationResult validateResource(ResourceConstellation.UserOwnedResource targetResource) throws ShapeTreeException, URISyntaxException {
        return validateResource(targetResource, null);
    }

    public ValidationResult validateResource(ResourceConstellation.UserOwnedResource targetResource, URI focusNodeURI) throws ShapeTreeException, URISyntaxException {
    ...
    public ValidationResult validateContainedResource(ResourceConstellation.UserOwnedResource containedResource) throws ShapeTreeException, URISyntaxException {
    ...
    public ValidationResult validateContainedResource(ResourceConstellation.UserOwnedResource containedResource, URI targetShapeTreeURI, URI focusNodeURI) throws ShapeTreeException, URISyntaxException {
