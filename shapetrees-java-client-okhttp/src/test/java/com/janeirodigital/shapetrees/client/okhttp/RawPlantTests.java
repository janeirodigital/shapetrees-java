...
public class RawPlantTests  extends BaseShapeTreeTest {
    ...
    void testPlantFailRootNotContainer() {
        ...
        ShapeTreeClientConfiguration validatingConfig = new ShapeTreeClientConfiguration(true, false);
    ...
    void testVanillaPostToManagedContainer() {
        ...
        applyCommonHeaders(context, builder, "http://hl7.org/fhir/Condition/example", getURI(server,"/static/shapetrees/medical-record/shapetree#condition"), false, "condition1", "text/turtle");
